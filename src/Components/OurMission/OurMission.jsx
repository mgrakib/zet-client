    ...
    return (
		<div>
			<div className='relative'>
				...
				<div className='absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 text-white text-center max-w-[600px]'>
					<h3 className='text-[40px] font-[700]'>OUR MISSION</h3>
